    ...
    function () {
      ...
      async function fetchMovies() {
        try {
          ...
          if (!res.ok)
            throw new Error("Something went wrong with fetching movide");
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  // We want the number of clicks on the rating bar
  ...
  function handleAdd() {
    ...
    // // React passes the current state value into the function
    // // x could be anything or (value) => (value + userRating)
  ...
  // This useEffect is run only once
  useEffect(
    function () {
